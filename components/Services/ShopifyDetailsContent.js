                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-8 col-md-12">
                                <div className="services-details-desc">
                                    ...
                                    <p>Please give an eComIN representative a call at +46 761 734 777 or fill out the quote request form below to learn more about Shopify and using it for your needs.</p>
                                    <div className="services-details-info">
                                        <h3>Maximise Your Shopify Experience With eComIN </h3>
                                        <p>After working on the Shopify platform for over a decade, eComIN can provide the guidance you need to determine which plan works best for your business. Then, we can maximise website performance within the package you select.</p>
                                        <p><b>Shopify
